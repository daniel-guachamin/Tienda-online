...
import com.danielta.ejb.TelefonoFacadeLocal;
import com.danielta.model.Telefono;
...
public class TelefonoController implements Serializable {
    ...
    //util para dar prioridad de acceso a la hora de cerrar el dialogo ,segun el permiso del usuario
    //permite controlar esta accion haciendolo de esta manera
    public void mostrarDialogo(){
        //logica de validacion
        this.setAccion("R"); //necesario para mostrar el boton registrar
        
        RequestContext req = RequestContext.getCurrentInstance();
        req.execute("PF('wdialogo').show();"); //mostrar dialogo
    }
}
